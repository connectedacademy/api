...
module.exports = function (app, passport, io) {
  ...
  app.get('/v1/auth/twitter/callback/:instance', function (req, res, next) {
    ...
    passport.authenticate('twitter', {
      ...
      successRedirect: (process.env.ENVIRONMENT == 'production') ? `https://${req.params.instance}.connectedacademy.io/profile` : 'http://localhost:8080/profile',
      failureRedirect: (process.env.ENVIRONMENT == 'production') ? `https://${req.params.instance}.connectedacademy.io/auth` : 'http://localhost:8080/auth'
    })(req, res, next)
  })
}
