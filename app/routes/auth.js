...
module.exports = function (app, passport, io) {
  ...
  app.get('/v1/auth/twitter/callback/:instance', function (req, res, next) {
    ...
    passport.authenticate('twitter', {
      ...
      successRedirect: process.env.DEV_MODE ? `http://ca.local/profile` : `https://${req.params.instance}.connectedacademy.org/profile`,
      failureRedirect: process.env.DEV_MODE ? `http://ca.local/auth` : `https://${req.params.instance}.connectedacademy.org/auth`
    })(req, res, next)
  })
}
